...
<body>
    ...
    <main class="bg-light">
      <section class="container py-5">
        <h1>Classes</h1>
        <p>Join interactive and collaborative classes to enhance your learning experience.</p>
            <div class="row">
                <?php
                ...
                $sql = "SELECT class_name, description FROM classes";
